...
class Level_01(Level):
    ...
    def __init__(self, player):
        ...
        level =   [
                  ...
                  #1
                  [platforms.GRASS_LEFT, 500, 400],
                  [platforms.GRASS_MIDDLE , 570, 400],
                  [platforms.GRASS_RIGHT, 640, 400], 
                  #2
                  [platforms.GROUND_PLATFORM_LEFT, 500, 150],
                  [platforms.GROUND_PLATFORM_MIDDLE, 570, 150],
                  [platforms.GROUND_PLATFORM_RIGHT, 640, 150], 
                  
                                    
                  #3
                  [platforms.GRASS_LEFT, 200, 280],
                  [platforms.GRASS_MIDDLE, 270, 280],
                  [platforms.GRASS_RIGHT, 340, 280], 
                  #4
                 ...
                 # [platforms.PIEDRA_FLOTANTE_IZQUIERDA, 1100, 500],
                  ...
                  #6
                  [platforms.GROUND_PLATFORM_LEFT, 1120, 280],
                  [platforms.GROUND_PLATFORM_MIDDLE, 1190, 280],
                  [platforms.GROUND_PLATFORM_RIGHT, 1260, 280],
                  ...
                  [platforms.ESTRELLA_NINJA, 2230, 330],                  
                  
                  #7
                  [platforms.GRASS_LEFT, 2600, 400],
                  [platforms.GRASS_MIDDLE, 2670, 400],
                  [platforms.GRASS_RIGHT, 2740, 400],
                  #8
                  [platforms.GRASS_LEFT, 2900, 300],
                  [platforms.GRASS_MIDDLE, 2970, 300],
                  [platforms.GRASS_RIGHT, 3040, 300],  
